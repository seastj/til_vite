...
function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-800 dark:bg-neutral-800 dark:text-neutral-100 ">
      <Router>
        {/* 헤더 */}
        <header className="sticky top-0 z-10 bg-white/80 backdrop-blur border-b border-neutral-200 dark:bg-neutral-950/60 dark:border-neutral-800">
        ...
        <footer className="mt-8 border-t border-neutral-200 py-6 text-center text-sm text-neutral-500 dark:border-neutral-800 dark:text-neutral-400">
          ...
          &copy; 2025 by{" "}
          <a href="mailto:dev.seastj@gmail.com">dev.seastj@gmail.com</a>
        </footer>
      </Router>
    </div>
  );
