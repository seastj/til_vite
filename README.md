...
- useState 는 컴포넌트 리렌더링 변수(지역)
- Context 는 앱 리렌더링 변수(전역)
...
- 실제 서비스는 상당히 기능이 많고, context 가 많다.
- Context 의 내용을 세분화해서 파일 및 폴더로 구성한다.
- contexts/todos 폴더 생성

### 3.1. state 의 초기값 파일

- contexts/todos/initialState.js 생성
